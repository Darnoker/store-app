...
class OrderOutboxRelayAdapterTest {
    ...
    void mapsClaimedOutboxEventsToOutboundMessages() {
        ...
        List<OutboundMessage> messages = new OrderOutboxRelayAdapter(repository)
    ...
    private OutboxEvent event() {
        ...
        return new OutboxEvent(UUID.randomUUID(), UUID.randomUUID(), "ORDER_CREATED", "order-topic", "{}", occurredAt,
